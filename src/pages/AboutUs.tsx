    ...
    <div className="min-h-screen bg-[#faf5ef] selection:bg-[#ec7719] selection:text-white font-sans text-gray-900 overflow-hidden">
      ...
      <section className="px-6 md:px-12 lg:px-24 py-20 md:py-32 relative z-10 -mt-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          >
            {/* The yellow offset background (bottom-left) */}
            <div className="absolute top-4 -left-4 md:top-6 md:-left-6 w-full h-full bg-[#fef08a] rounded-[2rem] md:rounded-[3rem] -z-10" />

            {/* The White Card Frame */}
            <div className="relative bg-white rounded-[2rem] md:rounded-[3rem] border-[4px] md:border-[6px] border-[#111] p-4 md:p-8 flex flex-col justify-center shadow-sm group z-10">
              
              {/* Full Image (w-full h-auto prevents cropping) */}
              <img 
                src={store} 
                alt="Mr. Squash Storefront" 
                className="w-full h-auto rounded-xl border-2 border-gray-100 group-hover:scale-[1.02] transition-transform duration-300" 
              />

              {/* Tilted Red Flagship Badge */}
              <div className="absolute -bottom-4 md:-bottom-6 -right-2 md:-right-6 bg-red-500 text-white font-black text-[10px] md:text-sm tracking-widest uppercase px-5 py-3 md:px-6 md:py-4 rounded-full border-[4px] border-[#111] -rotate-6 shadow-md z-20 whitespace-nowrap">
                Flagship Store
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-orange-100 flex flex-col gap-4">
              <p className="text-gray-600 font-bold text-base leading-relaxed">
                Mr. Squash is a fast-food restaurant dedicated to serving
                affordable, nutritious, and high-quality meals. We specialize in
                unique offerings like chicken coated in calabasa.
              </p>
              <p className="text-gray-600 font-bold text-base leading-relaxed">
                Located near schools and community areas, our store provides a
                convenient, comfortable, and eco-friendly dining space where
                families and students can relax safely.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            <p className="text-gray-300 font-bold text-base md:text-lg leading-relaxed">
              To provide a healthier twist on comfort food by integrating
              high-quality, locally sourced calabasa into budget-friendly meals,
          ...
          >
            ...
            <p className="text-gray-700 font-bold text-base md:text-lg leading-relaxed">
              To be the leading innovator in the local fast-food industry,
              recognized for transforming everyday vegetables into extraordinary
