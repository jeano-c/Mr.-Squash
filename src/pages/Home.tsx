...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#faf5ef] selection:bg-white selection:text-[#ec7719] flex flex-col">
          ...
          <div className="w-full relative z-20 flex flex-col justify-center pt-8 lg:pt-0 h-100">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="mt-6 text-orange-50 text-base md:text-lg leading-relaxed max-w-md font-medium h-15">
                  {activeCombo.desc}
                </p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button
                      ...
                      className="bg-white text-[#ec7719] font-black text-sm px-8 py-4 rounded-full
                        hover:bg-orange-50 hover:scale-105 active:scale-95 transition-all duration-300 shadow-xl tracking-widest uppercase"
                    >
                      Order Now
                    </button>
                    <button
                      ...
                      className="border-2 border-white/40 text-white font-bold text-sm px-8 py-4 rounded-full
                        hover:bg-white/15 hover:border-white hover:scale-105 active:scale-95 transition-all duration-300 tracking-widest uppercase backdrop-blur-sm"
                    >
                      View Menu
                    </button>
                  </div>
          ...
          <div className="relative w-full h-100 lg:h-150 flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
            <AnimatePresence mode="wait">
              <motion.img
                ...
                className="absolute w-[90%] lg:w-[115%] max-w-150 lg:max-w-200 object-contain drop-shadow-[0_30px_60px_rgba(0,0,0,0.6)] z-10"
              />
            </AnimatePresence>
      ...
      ══════════════════════════════════════════ */}
      <section className="bg-[#faf5ef] py-24 md:py-32 px-6 relative z-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center md:text-left mb-16">
            ...
            <p className="text-gray-500 font-medium mt-6 max-w-lg md:mx-0 mx-auto text-sm md:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 auto-rows-auto md:auto-rows-[300px] gap-5 md:gap-6">
            ...
            <div
              ...
              border border-orange-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-end relative overflow-hidden min-h-70"
            >
            ...
            <div
              ...
              border border-orange-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-center items-center text-center relative min-h-70"
            >
            ...
            <div
              ...
              hover:shadow-[0_10px_40px_rgba(236,119,25,0.4)] hover:-translate-y-1 transition-all duration-300 min-h-70 relative overflow-hidden"
            >
              ...
              <button
                onClick={() => navigate("/menu")}
                className="relative z-10 bg-white text-[#ec7719] font-black text-sm md:text-base px-8 py-4 rounded-full 
